...
class DockerClient {
 ...
 public:
    ...
    /**
     * @brief Create a docker image from a Dockerfile
     * 
     * @param dockerfile Path to the Dockerfile use for bulding the image
     * @param taggedName Name and tag for the image in the form 'name:tag'
     * 
     * @throws DockerOperationError In case of error, throw an exception with the error message
     */

...
IOTest::IOTest()
    : unix_client(DockerClientpp::SOCK_UNIX, "/var/run/docker.sock"),
#ifdef CI_TEST
      tcp_client(DockerClientpp::SOCK_UNIX, "/var/run/docker.sock"),
#else
      tcp_client(DockerClientpp::SOCK_TCP, "127.0.0.1:8888"),
#endif
      uri("/images/json"),
